...
void setupStory()
{
    ...
    story[max_scenes++] = (struct Clip) {initDummy160, drawDummy, clearScreen, doNothing, doNothing, 100, DBUF};
    //story[max_scenes++] = (struct Clip) {initDummy160, drawDummy, clearScreen, doNothing, doNothing, 100, DBUF};
    ...
    story[max_scenes++] = (struct Clip) {initExample1, drawExample1, clearScreen, doNothing, doNothing, 900, DBUF};
    story[max_scenes++] = (struct Clip) {initExample2, drawExample2, clearScreen, doNothing, doNothing, 650, DBUF};
    story[max_scenes++] = (struct Clip) {initDummy160, drawDummy, clearScreen, doNothing, doNothing, 5, DBUF};
    story[max_scenes++] = (struct Clip) {initExample3, drawExample3, clearScreen, doNothing, doNothing, 4000, DBUF};
